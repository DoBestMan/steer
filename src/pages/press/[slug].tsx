...
const PressPageTemplate = WithErrorPageHandling(OpenTemplatePage);

export async function getStaticPaths() {
  backendBootstrap();
  const res = await backendGetPageSlugList(slugListBasePath.pressPage);
...
export default WithErrorPageHandling(PressPageTemplate);
