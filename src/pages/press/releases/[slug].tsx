...
const PressReleaseTemplate = WithErrorPageHandling(OpenTemplatePage);

export async function getStaticPaths() {
  backendBootstrap();
  const res = await backendGetPageSlugList(slugListBasePath.pressReleases);
...
export default WithErrorPageHandling(PressReleaseTemplate);
