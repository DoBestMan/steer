...
const PressNewsTemplate = WithErrorPageHandling(OpenTemplatePage);

export async function getStaticPaths() {
  backendBootstrap();
  const res = await backendGetPageSlugList(slugListBasePath.pressInTheNews);
...
export default WithErrorPageHandling(PressNewsTemplate);
