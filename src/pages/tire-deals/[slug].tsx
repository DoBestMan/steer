...
const TireDealsTemplatePage = WithFallbackPageHandling(
...
export async function getStaticPaths() {
  return {
    paths: [],
    fallback: true, // fallback is false so a wrong slug leads to a 404
  };
}
...
export default TireDealsTemplatePage;
