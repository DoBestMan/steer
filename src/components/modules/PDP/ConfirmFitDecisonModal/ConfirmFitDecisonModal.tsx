...
import { checkDecisionModalLabel } from '../ConfirmFitInsight/ConfirmFitInsight.utils';
...
function ConfirmFitDecisionModal({
  ...
  const closeDecisionFitModal = () => {
    onClose();
    if (shouldReloadAfterDecisionModal) {
      setTimeout(() => {
  ...
  return (
    <BottomCardModal
      contentLabel={ui('pdp.insights.confirmFitDecisionModal')}
